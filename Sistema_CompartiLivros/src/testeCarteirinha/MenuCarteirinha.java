...
public class MenuCarteirinha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCConfirmar.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        btnCConfirmar.setText("Confirmar");
        btnCConfirmar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCConfirmarActionPerformed(evt);
            }
        });
